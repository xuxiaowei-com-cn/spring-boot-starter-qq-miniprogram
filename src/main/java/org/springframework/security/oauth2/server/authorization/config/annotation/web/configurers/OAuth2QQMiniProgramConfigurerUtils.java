...
public class OAuth2QQMiniProgramConfigurerUtils {
	...
	public static QQMiniProgramService getQQMiniProgramService(HttpSecurity httpSecurity) {
		QQMiniProgramService qqMiniProgramService = httpSecurity.getSharedObject(QQMiniProgramService.class);
		if (qqMiniProgramService == null) {
			qqMiniProgramService = OAuth2ConfigurerUtils.getOptionalBean(httpSecurity, QQMiniProgramService.class);
			if (qqMiniProgramService == null) {
				QQMiniProgramProperties qqMiniProgramProperties = OAuth2ConfigurerUtils.getOptionalBean(httpSecurity,
						QQMiniProgramProperties.class);
				qqMiniProgramService = new InMemoryQQMiniProgramService(qqMiniProgramProperties);
			}
		}
		return qqMiniProgramService;
	}
