 ...
 */
public class OAuth2QQMiniProgramAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	 ...
	 * 授权类型：QQ小程序
	 */
	public static final AuthorizationGrantType QQ_MINIPROGRAM = new AuthorizationGrantType("qq_miniprogram");
	 ...
	 */
	public OAuth2QQMiniProgramAuthenticationToken(Authentication clientPrincipal,
			Map<String, Object> additionalParameters, String appid, String code, String scope) {
		super(OAuth2QQMiniProgramAuthenticationToken.QQ_MINIPROGRAM, clientPrincipal, additionalParameters);
