...
@Data
@Component
@ConfigurationProperties("qq.mini.program")
public class QQMiniProgramProperties {

	/**
	 * QQ小程序属性配置列表
	 */
	private List<QQMiniProgram> list;

	/**
	 * 默认QQ小程序的权限
	 * <p>
	 * 若要自定义用户的权限，请开发者自己实现 {@link QQMiniProgramService}
	 */
	 ...
	 */
	@Data
	public static class QQMiniProgram {
