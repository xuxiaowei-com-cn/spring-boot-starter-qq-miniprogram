 ...
 */
public class OAuth2QQMiniProgramAuthenticationProvider implements AuthenticationProvider {
	 ...
	 */
	public final String JS_CODE2_SESSION_URL = "https://api.q.qq.com/sns/jscode2session?appid={appid}&secret={secret}&js_code={js_code}&grant_type=authorization_code";
	...
	@Setter
	private QQMiniProgramService qqMiniProgramService;

	public OAuth2QQMiniProgramAuthenticationProvider(HttpSecurity builder) {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		OAuth2QQMiniProgramAuthenticationToken grantAuthenticationToken = (OAuth2QQMiniProgramAuthenticationToken) authentication;
		...
		builder.authorizationGrantType(OAuth2QQMiniProgramAuthenticationToken.QQ_MINIPROGRAM);

		AbstractAuthenticationToken abstractAuthenticationToken = qqMiniProgramService.authenticationToken(
		...
		DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
				...
				.authorizationGrantType(OAuth2QQMiniProgramAuthenticationToken.QQ_MINIPROGRAM)
	...
	public boolean supports(Class<?> authentication) {
		return OAuth2QQMiniProgramAuthenticationToken.class.isAssignableFrom(authentication);
	}
	...
	private void variableDefaults() {
		if (authorizationService == null) {
			authorizationService = OAuth2QQMiniProgramConfigurerUtils.getAuthorizationService(builder);
		}

		if (tokenGenerator == null) {
			tokenGenerator = OAuth2QQMiniProgramConfigurerUtils.getTokenGenerator(builder);
		}

		if (qqMiniProgramService == null) {
			qqMiniProgramService = OAuth2QQMiniProgramConfigurerUtils.getQQMiniProgramService(builder);
		}
	}
